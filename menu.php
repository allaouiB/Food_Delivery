...
require('connect.php');
    ...
    $query = mysqli_query($conn, "SELECT `id`, `img`, `name`, `prix` FROM `food`");
	...
	$aa = mysqli_query($conn, "SELECT `iddrink`, `img`, `name`, `prix` FROM `drink`");

    if ($aa) {
        // Fetch all rows as an associative array
        $drink = mysqli_fetch_all($aa, MYSQLI_ASSOC);
    } else {
        // Handle query execution errors
        echo "Error: " . mysqli_error($conn);
    }

	$bb = mysqli_query($conn, "SELECT `idburger`, `img`, `name`, `prix` FROM `burger`");

    if ($bb) {
        // Fetch all rows as an associative array
        $burger = mysqli_fetch_all($bb, MYSQLI_ASSOC);
    } else {
        // Handle query execution errors
        echo "Error: " . mysqli_error($conn);
    }
    			...
    			<div class='col-lg-4 d-flex ftco-animate'>
    				<div class='services-wrap d-flex'>
    					...
    					<div class='text p-4'>
    						...
    						<p class='price'><span>$prix DH</span> <a href='reserve.php?id=".$idf."' class='ml-2 btn btn-white btn-outline-white'>Order</a></p>
    					</div>
    				</div>
    			</div>";
			}} ;?>
        ...
        foreach ($cit as $ct) {
            ...
            echo" 
		              		<div class='col-md-4 text-center'>
		              			<div class='menu-wrap'>
		              				<a href='#' class='menu-img img mb-4' style='background-image: url($img);'></a>
		              				<div class='text'>
		              					<h3><a href='#'>$name</a></h3>
		              					<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia.</p>
		              					<p class='price'><span>$prix DH</span></p>
		              					<p><a href='reserve.php?id=".$idf."' class='btn btn-white btn-outline-white'>Add to cart</a></p>
		              				</div>
		              			</div>
		              		</div>";
		              		...
		              		<div class='col-md-4 text-center'>
		              			<div class='menu-wrap'>
		              				...
		              				<div class='text'>
		              					...
		              					<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia.</p>
		              					<p class='price'><span>$prix DH</span></p>
		              					<p><a href='reservedr.php?id=".$idf."' class='btn btn-white btn-outline-white'>Add to cart</a></p>
		              				</div>
		              			</div>
		              		</div>";
		              		...
		              		<div class='col-md-4 text-center'>
		              			<div class='menu-wrap'>
		              				...
		              				<div class='text'>
		              					...
		              					<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia.</p>
		              					<p class='price'><span>$prix DH</span></p>
		              					<p><a href='reservebug.php?id=".$idf."' class='btn btn-white btn-outline-white'>Add to cart</a></p>
		              				</div>
		              			</div>
		              		</div>";
